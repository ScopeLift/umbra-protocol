...
contract GasTester {
    ...
    event HalfByte(address indexed sender, address indexed token, uint256 indexed amount, bytes32 b1, bytes32 b2, bytes32 b3, bytes32 b4, bytes32 b5, bytes32 b6, bytes16 b7);
    ...
    function halfByte(bytes32 b1,
                    ...
                    payable
    {
        emit HalfByte(msg.sender, address(0x00eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee), msg.value, b1, b2, b3, b4, b5, b6, b7);
    }
}
