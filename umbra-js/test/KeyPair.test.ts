...
describe('KeyPair class', () => {
  ...
  describe('Initialization', () => {
    ...
    itIfForking('initializes an instance from a regular transaction', async () => {
    ...
    itIfForking('initializes an instance from a contract interaction transaction', async () => {
      // Specify Sepolia transaction hash and its sender
    ...
    itIfForking('initializes an instance from a contract creation transaction', async () => {
      // Specify sepolia transaction hash and its sender
  ...
  describe('Functionality', () => {
    itIfForking('will recover the public key from an arbitrary transaction', async () => {
      // Specify sepolia transaction hash and its sender
