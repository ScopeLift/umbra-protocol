...
export const POLYGON_MAINNET_RPC_URL = `https://polygon-mainnet.infura.io/v3/${String(process.env.INFURA_ID)}`;
export const POLYGON_PROVIDER = new StaticJsonRpcProvider(POLYGON_MAINNET_RPC_URL);
