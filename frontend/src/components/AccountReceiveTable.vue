<template>
  <div>
    ...
    <div v-else>
      ...
      >
        The stealth keys published for this account do not match those generated by it. Please navigate to the
        <router-link class="hyperlink" :to="{ name: 'setup' }">Setup</router-link> page and complete the setup flow to
        ensure the keys published match this account. Failure to do so may result in payments sent to your account being
        difficult, or even impossible, to withdraw.
        <router-link class="hyperlink" :to="{ name: 'FAQ', hash: '#account-setup' }">Learn more</router-link>.
      </div>
